...
class SniperClass extends CharacterClass
{
    ...
    private LoadSets() : void
    {
        ...
        for(let i = 0; i < 1; i++) SpriteSetSkin.Sprites.push("Resources/Textures/Characters/Sniper/Image_0_"+i+".png");
        this.SpriteSets.push(SpriteSetSkin);
    }

    private LoadSkills():void
    {
        this.Skills.push(new NeuralBomb(this), new NeuralBomb(this), new NeuralBomb(this), new CannonBlast(this));
    }

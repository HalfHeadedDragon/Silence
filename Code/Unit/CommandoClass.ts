...
class CommandoClass extends CharacterClass
{
    ...
    private LoadSets() : void
    {
        ...
        for(let i = 0; i < 1; i++) SpriteSetSkin.Sprites.push("Resources/Textures/Characters/Commando/Image_0_"+i+".png");
        this.SpriteSets.push(SpriteSetSkin);
    }

    private LoadSkills():void
    {
        this.Skills.push(new CannonBlast(this), new NeuralBomb(this), new CannonBlast(this), new NeuralBomb(this));
    }
}